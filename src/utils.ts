...
export function loadConfig(): PluginConfig {
  ...
  return {
    ...
    distinctId,
    projectName:
      process.env.POSTHOG_PROJECT_NAME || basename(process.cwd()) || "opencode-project",
    tags,
    maxAttributeLength:
      parseInt(process.env.POSTHOG_MAX_ATTRIBUTE_LENGTH ?? "12000", 10) || 12000,
  }
}
...
export function redactForPrivacy<T>(
  value: T,
  privacyMode: boolean,
): T | null {
